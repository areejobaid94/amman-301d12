...
//   return `I am currently enrolled in ${course}`;
// };
const withoutParens = course => `I cam currently enrolled in ${course}`;
...
// Student Object {name: "Joe", age: "Schmoe", hometown: 100}
// 2. What is "this" when joe.scopeArrow() is invoked?
// Window Object 
// 3. Explain why "this" is different when an arrow function is used.
//The arrow function resolves this lexically. In another words, the arrow function doesn’t define its own execution context.
